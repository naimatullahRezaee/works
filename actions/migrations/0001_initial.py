    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_obj', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='target_obj', to='contenttypes.contenttype')),
        ...
        migrations.AddIndex(
            model_name='action',
            index=models.Index(fields=['target_obj', 'target_id'], name='actions_act_target__f60acc_idx'),
        ),
    ]
